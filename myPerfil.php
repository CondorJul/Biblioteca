	...
	<body>
		...
		<div class="container">
			<aside class="col-sm-12 col-md-12 col-lg-12">
				<div class="container-fluid">
					<br>
					<form action="guardarPerfil.php" name="formulario" class="form-horizontal col-md-8 col-md-offset-2" method="POST" style="border-style: double; border-color: white; border-radius: 15px; color: #49c7fc;">
						<br>
						<div class="form-group">
							<div class="col-md-11">
								<h4 class="modal-title" class="col-md-7"><i class='glyphicon glyphicon-user'></i> Edite sus Datos</h4>
							</div>
